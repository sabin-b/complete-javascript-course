...
(0, _shoppingCartJs.addToCart)("chair", 25);
(0, _shoppingCartJsDefault.default)("jug", 50);
...
let selfinvoke = function() {
    ...
    function cart(product, quantity) {
        ...
        console.log(`your items ${product} , ${quantity} added to bag, with shipping cost ${shippingCost} `);
    }
    return {
        addToCart,
        cart
...
let newState = (0, _cloneDeepJsDefault.default)(state);
